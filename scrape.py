...
try:
    ...
    sys.path.append(r'C:\Users\csunj\Downloads\getPhotos\components')
...
class Profile(object):
    def __init__(self, Id=None, persons=None, abouts=None, jobs=None, schools=None,  certs=None, volunteers=None, skills=None, refs=None, feats=None, interests=None):    
